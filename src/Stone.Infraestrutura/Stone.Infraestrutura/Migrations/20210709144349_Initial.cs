    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Bandeira = table.Column<string>(type: "varchar(25)", nullable: false),
                    NomeDoTitular = table.Column<string>(type: "varchar(100)", nullable: false),
                    Numero = table.Column<string>(type: "varchar(16)", nullable: false),
                    Validade = table.Column<string>(type: "varchar(4)", nullable: false),
                    CodigoDeSeguranca = table.Column<string>(type: "varchar(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    IdUsuario = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdAplicativo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transacao_AspNetUsers_IdUsuario",
                        column: x => x.IdUsuario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transacao_Cartoes_IdCartao",
                        column: x => x.IdCartao,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacao_IdAplicativo",
                table: "Transacao",
                column: "IdAplicativo");

            migrationBuilder.CreateIndex(
                name: "IX_Transacao_IdCartao",
                table: "Transacao",
                column: "IdCartao");
        }
